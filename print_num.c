...
{
	int i = BUFF_SIZE - 2;
	unsigned long int num = va_arg(list_arg, unsigned long int);
...
int print_hexadecimal(va_list list_arg, char buffer[],
	int flags, int width, int precision, int size)
{
	return (print_hexa(list_arg, "0123456789abcdef", buffer,
 ...
 * Return: Number of chars printed
 */
int print_hexa(va_list list_arg, char map_to[], char buffer[],
